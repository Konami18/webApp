            ...
            <div align="center" style="padding-top: 100px">
                ...
                <table align="center">
                    ...
                    <tr align="center" style="background-color:rgb(184, 181, 181) ">
                        ...
                        <td style="color: black"><img height="200px" width="200px"
                                src="doctorimage/{{ $doctor->image }}" alt=""></td>

                        <td><a onclick="return confirm('Bạn chắc chắn muốn xóa Bác sĩ? ')" class="btn btn-danger"
                                href="{{ url('deletedoctor', $doctor->id) }}">xóa</a></td>
