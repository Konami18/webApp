            ...
            <div class="container">
                ...
                <form action="#">
                    <div class="input-group input-navbar">
                        ...
                        <input type="text" class="form-control" placeholder="Tim kiem" aria-label="Username"
    ...
    <div align="center" style="padding: 70px;">
        ...
        <table>
            ...
            <tr style="background-color: rgb(233, 233, 233);" align="center">
                ...
                <td><a class="bt btn-danger" onclick="return confirm('Bạn chắc chắn xóa chưa?')"
                        href="{{ url('cancel_appoint', $appoints->id) }}">Xóa</a></td>
            </tr>
